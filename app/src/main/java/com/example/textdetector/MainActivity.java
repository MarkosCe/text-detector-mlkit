...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Test Image 1 (Text)", "Test Image 2 (Face)", "ine"};
    ...
    private void processTextRecognitionResult(Text texts) {
        ...
        for (int i = 0; i < blocks.size(); i++) {
            if (blocks.get(i).getText().contains("NOMBRE")){
                Toast.makeText(this, blocks.get(i).getText(), Toast.LENGTH_SHORT).show();
                textView.setText(blocks.get(i).getText());
            }
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                mSelectedImage = getBitmapFromAsset(this, "ine_credencial.jpeg");
                break;
        }
